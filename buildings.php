...
<td  valign="top" style="
width:960px;
border:1px solid #b52025; background-image:url(images/city2.png); background-repeat:no-repeat; background-position:center;">
...
<td width="67%" style="color:#999999; font-size:28px; font-style:inherit; font-family:Calibre; font-weight:500; padding-left:20px">Buildings</td>
<td width="33%" style="background:url(images/menu.png); padding-left:10px; color:#FFFFFF">|BUILDINGS|</td>
</tr>
...
Marlum Nigeria limited  was the main contractor, in the construction of Enugu State University permanent site with full infrastructure like the road network,water reticulation/boreholes etc Ebeano-City Campus. The project include buildings for all the faculties, residence , libraries and insructions, Our involvement in this section has built award-winning teams.
<br />
<b>Public Buildings</b>
MARLUM's ability to successfully bid for contract in a competitive environment is confirmed by the number of high profile, distinguished public buildings it has been awarded . These projects include the prestigious International conference Centre, Enugu .MEGA PLAZA shopping complex.V/I Lagos. e.t.c..
<br />
<b>Hospitals</b>
Much of MARLUM's involvement in the hospital sector has been through additions and renovation work. MARLUM also contructed the Enugu State University Teaching Hospital(college of medicine) in Enugu. 
</td>
</td>
