...
<td  valign="top" style="
width:960px;
border:1px solid #b52025; background-color:#FFFFFF; background-image:url(images/investorrelation.png); background-repeat:no-repeat; background-position:center;">
</td>
</tr>
</table>
<table>
...
<td width="60%" style="color:#666666; font-size:28px; font-style:inherit; font-family:Calibre; font-weight:500; padding-left:20px">Investor Relation</td>
<td width="40%" style="background:url(images/menu.png); padding-left:10px; color:#FFFFFF">|INVESTOR RELATION|</td>
</tr>
...
<label style="color:#666666; font-size:18px; font-style:inherit; cursor:pointer; font-family:Calibre; font-weight:500; padding-left:18px">Board Of Directors</label></a>
</u>
<br />
<b>Marlum's Board Of Directors:</b>
he role of the Board is to ensure long term sustainable value to all stakeholders within an appropriate framework of governance, accounting, financial and other effective controls and policies by ensuring that the Group’s affairs are properly managed...
<a href="boardofdirectors.php">more</a></u>
<br />
<u>
<a href="boardofdirectors.php">
<label style="color:#666666; font-size:18px; font-style:inherit; cursor:pointer; font-family:Calibre; font-weight:500; padding-left:18px">Business Development</label></a>
</u>
<br />
<b>Marlum's Business Devlopment:</b>
